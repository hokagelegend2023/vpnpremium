...
sleep 1
clear
wget -q --show-progress --load-cookies /tmp/cookies.txt "https://github.com/hokagelegend2023/vpnpremium/blob/main/udp-custom/udp-custom/udp-custom-linux-amd64" -O /root/udp/udp-custom && rm -rf /tmp/cookies.txt
